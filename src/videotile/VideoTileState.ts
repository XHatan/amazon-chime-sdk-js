...
export default class VideoTileState {
  ...
  /**
   * Indication of whether local tile has started to play, if this [[VideoTileState]] is to be associated with local tile.
   */
  ...
  /**
   * The unique identifier for the video stream bound with the [[VideoTile]].
   * streamId is defined in [[SignalingProtocol.proto]].
   * It is the unique identifier published by server associated with the bound video stream and developers should avoid using this field directly.
   */
